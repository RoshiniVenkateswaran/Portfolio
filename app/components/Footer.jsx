...
// LeetCode mark: folded chevron only (reads clearly at small sizes; omits the tiny grid corner from the full brand SVG)
const LeetCodeLogo = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden>
    <path d="M13.483 0a1.374 1.374 0 0 0-.961.438L7.116 5.526l5.417 5.436a1.375 1.375 0 0 0 1.958 0L19.55 5.526a1.374 1.374 0 0 0 0-1.957L13.62.438A1.374 1.374 0 0 0 12.483 0h-1zm3.123 6.44a1.375 1.375 0 0 0-.962.438L2.561 20.078a1.375 1.375 0 0 0 0 1.956l5.452 5.457a1.375 1.375 0 0 0 1.958 0L23.44 8.334a1.375 1.375 0 0 0 0-1.954l-5.453-5.457a1.375 1.375 0 0 0-.961-.438v-.001z" />
  </svg>
)
