...
const Home = () => {
  ...
  // Movement range for name animation
  const nameX = useTransform(scrollYProgress, [0, 1], [0, -1950]);
  ...
  return (
    <div className="relative" style={{ overflowX: 'hidden' }}>
      ...
      >
        <div className="max-w-7xl mx-auto w-full relative" style={{ minHeight: 'calc(100vh - 5rem)' }}>
          {/* Text on Left, Photo on Right */}
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12 pt-16 lg:pt-20 mb-32">
          ...
          <div 
            ...
            className="absolute left-0 py-4 lg:py-8"
            style={{
              bottom: '-3rem',
              width: '100vw',
              overflow: 'visible',
          ...
          >
            <motion.div
              ...
              style={{
                x: nameX,
                fontSize: 'clamp(2rem, 18vw, 13rem)',
                lineHeight: '0.9',
                fontWeight: '700',
